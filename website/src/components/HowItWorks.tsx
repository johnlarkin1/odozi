...
const steps = [
  {
    number: "1",
    title: "Open Odyssey",
    description: "Launch the app and tap today's check-in card.",
  ...
  {
    number: "2",
    title: "Answer 8 prompts",
    description: "Mood, gratitude, wins, tensions — each one skippable.",
  ...
  },
  {
    ...
    description: "Over days and weeks, Odyssey surfaces insights about your wellbeing.",
