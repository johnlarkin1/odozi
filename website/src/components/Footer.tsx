        ...
        <div className="grid grid-cols-2 gap-8 sm:grid-cols-4">
          ...
          <div className="flex flex-col gap-3 text-sm">
            ...
            <a
              ...
              className="inline-flex w-fit items-center gap-2 rounded-lg border border-white/10 px-4 py-2.5 text-sm text-star-white/70 transition hover:border-white/20 hover:text-star-white"
            >
