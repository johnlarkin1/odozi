    ...
    <section className="relative overflow-hidden px-6 py-36">
      ...
      <div className="relative mx-auto max-w-3xl text-center">
        ...
        >
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-x-8 gap-y-3 text-sm text-star-white/50 sm:text-base">
          ...
          <div className="mt-12">
            <a
              ...
              className="inline-flex items-center gap-3 rounded-full bg-star-white px-8 py-4 text-lg font-semibold text-deep-space transition hover:bg-star-white/90 sm:px-10 sm:py-5 sm:text-xl"
            >
